...
class PDF extends FPDF {
    function Header() {
        ...
        $this->Cell(60,10,'Programme',1,0,'C');
        $this->Cell(30,10,'Year',1,1,'C');
    }
}

$sql = "SELECT c.full_name, c.reg_no, c.programme, c.academic_year
...
foreach($students as $st){
    $pdf->Cell(60,10,$st['full_name'],1,0);
    $pdf->Cell(40,10,$st['reg_no'],1,0);
    $pdf->Cell(60,10,$st['programme'],1,0);
    $pdf->Cell(30,10,$st['academic_year'],1,1);
}
